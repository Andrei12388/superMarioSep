...
export class CloudEnemy {
    constructor(game, x, y) {
        ...
        this.moveTimer = 0;
        this.moveDuration = Math.random() * 2 + 1; // 1–3 seconds
        ...
        this.frames = new Map([
             ['idle', [
                [[286, 15, 86, 53], [43, 51], { push: [-33, -43, 76, 43], hurt: [-33, -43, 76, 43] }],
            ]],           
             ['dead', [
                [[383, 15, 85, 53], [43, 51], { push: [0, 0, 0, 0], hurt: [0, 0, 0, 0] }],
            ]],        
        ]);
...
this.moveTimer += time.secondsPassed;
